...
Exstream uses semantic versioning. Patch releases preserve the documented public
API and behavior. Minor releases may add compatible API. Incompatible API or
behavior changes require a major release unless they fix a security issue or a
clearly documented defect.
